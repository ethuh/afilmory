...
import { VideoInfoPanelContent } from '~/modules/metadata/VideoInfoPanel'
import type { VideoManifestItem } from '~/types/media'

type Tab = 'info'

export const VideoInspectorPanel: FC<{
  currentVideo: VideoManifestItem
  onClose?: () => void
  visible?: boolean
}> = ({ currentVideo, onClose, visible = true }) => {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex min-h-0 flex-1">
        {activeTab === 'info' && <VideoInfoPanelContent currentVideo={currentVideo} visible={visible} />}
      </div>
    </m.div>
  )
}
